...
<html class="no-js h-100" lang="en">
    <head>
        <?php get_page_title('Manage Users'); ?>
                ...
                <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
                    ...
                    <div class="alert alert-success alert-dismissible fade show mb-0" role="alert" id="add-college-success-alert">
                        ...
                        <div class="main-content-container container-fluid px-4">
                            ...
                            <?php get_page_header('Manage Users'); ?>
                                                ...
                                                <table class="table mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $users = User::all();
                                                            if(!$users){
                                                                ?><tr><td>No users added yet!!</td><td></td><td></td><td></td><td></td><td></td></tr><?php
                                                            }else{
                                                                foreach($users as $user){
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo User::get_position($user->position); ?></td>
                                                                            <td>
                                                                                <label class="switch">
                                                                                    <input class="user-action-buttons" type="checkbox" data-user="<?php echo $user->id; ?>" <?php if($user->active) echo "checked"; ?>>
